...
window.utilities.listenForMessage("background", "content", "tabID", function (msg) {
...
window.utilities.listenForMessage("mainpanel", "content", "getRelationItems", function (msg) {
    _relation_finding__WEBPACK_IMPORTED_MODULE_1__["RelationFinder"].getRelationItems(msg);
});
window.utilities.listenForMessage("mainpanel", "content", "getFreshRelationItems", function (msg) {
    _relation_finding__WEBPACK_IMPORTED_MODULE_1__["RelationFinder"].getFreshRelationItems(msg);
});
window.utilities.listenForMessage("mainpanel", "content", "editRelation", function (msg) {
    _relation_finding__WEBPACK_IMPORTED_MODULE_1__["RelationFinder"].editRelation(msg);
});
window.utilities.listenForMessage("mainpanel", "content", "nextButtonSelector", function (msg) {
    _relation_finding__WEBPACK_IMPORTED_MODULE_1__["RelationFinder"].nextButtonSelector();
});
window.utilities.listenForMessage("mainpanel", "content", "clearNextButtonSelector", function (msg) {
    _relation_finding__WEBPACK_IMPORTED_MODULE_1__["RelationFinder"].clearNextButtonSelector();
});
window.utilities.listenForMessage("mainpanel", "content", "currentRecordingWindows", function (msg) {
    console.error('This function should never be called.');
    /* TODO: only restore these if the error above triggers
    window.currentRecordingWindows = msg.window_ids; */
});
window.utilities.listenForMessage("mainpanel", "content", "currentReplayWindowId", function (msg) {
...
window.utilities.listenForMessage("mainpanel", "content", "runNextInteraction", function (msg) {
    _relation_finding__WEBPACK_IMPORTED_MODULE_1__["RelationFinder"].runNextInteraction(msg);
});
window.utilities.listenForMessage("mainpanel", "content", "currentColumnIndex", function (msg) {
    _relation_finding__WEBPACK_IMPORTED_MODULE_1__["RelationFinder"].setEditRelationIndex(msg.index);
});
window.utilities.listenForMessage("mainpanel", "content", "clearRelationInfo", function (msg) {
    _relation_finding__WEBPACK_IMPORTED_MODULE_1__["RelationFinder"].clearRelationInfo(msg);
});
window.utilities.listenForFrameSpecificMessage("mainpanel", "content", "likelyRelation", function (msg, sendResponse) {
    window.MiscUtilities.registerCurrentResponseRequested(msg, function (m) {
...
window.utilities.listenForFrameSpecificMessage("mainpanel", "content", "getFreshRelationItems", function (msg, sendResponse) {
...
window.MiscUtilities.repeatUntil(function () {
